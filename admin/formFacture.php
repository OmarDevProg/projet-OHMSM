...
$clients = $db->select("SELECT id, nom, prenom FROM client");
...
<main class="main-content position-relative border-radius-lg ">
                        ...
                        <form method="POST" action="ajoutFacture.php" class="needs-validation" novalidate>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="client_id" id="client_id" class="form-control" required>
                                    ...
                                    <option value=""><a href="formClient.php"> (+) Nouveau client </a></option>
                            ...
                            <div id="produits">
                                <div class="produit mb-3">
                                        ...
                                        <select name="produit_id[]" class="form-control" required>
                                            ...
                                            <?php foreach ($produits as $produit): ?>
                                                <option value="<?php echo htmlspecialchars($produit['id']); ?>">
                                                    <?php echo htmlspecialchars($produit['title']); ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="decimal" name="remise[]" class="form-control" value="0">
                                    </div>
                                </div>
                            </div>

                            <!-- Add Product Button -->
                            <button type="button" class="btn btn-outline-secondary" onclick="ajouterProduit()">+ Ajouter un Produit</button><br><br>

                            <!-- Submit Button -->
                            <div class="d-flex justify-content-center mt-3">
                                <button type="submit" class="btn btn-primary px-5 py-2">Créer Facture</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        function ajouterProduit() {
            ...
            produitDiv.classList.add('produit', 'mb-3');
