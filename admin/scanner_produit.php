            ...
            <div class="col-md-11 mt-4">
                <div class="card shadow-lg rounded-lg">
                    ...
                    <div class="card-body p-4">
                        ...
                        <p>Total général : <span id="total_general">0.000 TND</span></p>
...
<div class="fixed-plugin">
    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body pt-sm-3 pt-0 overflow-auto">
            ...
            <a class="btn btn-outline-dark w-100" href="https://www.dasinformatique.com">View documentation</a>
            <div class="w-100 text-center">
                <a class="github-button" href="https://www.dasinformatique.com" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star creativetimofficial/argon-dashboard on GitHub">Star</a>
                <h6 class="mt-3">Thank you for sharing!</h6>
                <a href="https://www.dasinformatique.com" class="btn btn-dark mb-0 me-2" target="_blank">
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', () => {
            Swal.fire({
                icon: 'error',
                title: 'Erreur',
                text: decodeURIComponent("<?= addslashes($_GET['error']) ?>")
            });
        });
    </script>
<?php endif; ?>