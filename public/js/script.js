...
document.querySelectorAll('.add-to-cart').forEach(button => {
  button.addEventListener('click', function () {
    ...
    const productImagepath = productElement.dataset.productImagepath;
    ...
    Swal.fire({
      ...
      html: `
    <img src="${productImagepath}" alt="${productTitle}" style="width: 80px; height: 80px; border-radius: 8px; margin-bottom: 10px;">
